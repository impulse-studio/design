...
const TREE_MOTION = {duration: 0.12, ease: EASE_OUT} as const;
...
const ROW_ENTER = { duration: 0.12, ease: EASE_OUT } as const;
const BRANCH_DRAW = { duration: 0.12, ease: EASE_OUT } as const;
      ...
      {rows.map((row) => {
          ...
          return (
            <motion.div
              ...
              transition={reduce ? { duration: 0 } : TREE_MOTION}
            >
              <button
                ref={(node) => {
                ...
                className={cn(
                  ...
                  "transition-colors duration-120 motion-reduce:transition-none hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset",
