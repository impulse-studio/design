...
import { CatalogCard } from "@/pages/design-system/components/CatalogCard"
import { CatalogListGroup } from "@/pages/design-system/components/CatalogListGroup"
  ...
  return (
    <div className="flex min-w-0 flex-col gap-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <h1 className="page-title [font-family:var(--font-heading)] text-[22px] leading-[30px] font-semibold tracking-[-0.022em] [font-variation-settings:'opsz'_20]">
