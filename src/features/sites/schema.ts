...
import { libraryBindingSchema } from "@/features/libraries/schema"
export const siteKindSchema = z.enum(["react-vite", "vue-vite"])
export type SiteKind = z.infer<typeof siteKindSchema>
export const breakpointSchema = z.enum(["base", "tablet", "mobile"])
...
export const visualStyleKeySchema = z.union([
  stylePropertySchema,
...
export const siteChangeSchema = z.discriminatedUnion("type", [
  z.object({type:z.literal("file"),path:filePathSchema,content:z.string().max(200_000)}).strict(),
...
export type SiteRecord = { id: string; doc: SiteDocument; revision: number }
