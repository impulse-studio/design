...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(PaginationLast_default), normalizeProps(guardReactiveProps(delegatedProps.value)), {
        default: withCtx(() => [
          createVNode(_sfc_main$1, { "icon-name": "arrow-right-double-line" })
        ]),
        _: 1
      }, 16);
    };
