...
/* empty css                        */
/* empty css                                   */
import _sfc_main$2 from "../../input/email/DigiEmailInput.vue2.js";
/* empty css                                         */
/* empty css                                  */
/* empty css                             */
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "DigiEmailFormField",
  ...
  setup(__props, { expose: __expose }) {
    ...
    const computedZodSchema = computed(() => {
      const defaultSchema = props.required ? z.string().email() : z.union([z.string().email(), z.literal("")]).optional().nullable();
