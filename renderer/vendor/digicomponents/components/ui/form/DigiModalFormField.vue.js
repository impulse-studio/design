import { defineComponent, useModel, computed, toRefs, openBlock, createBlock, unref, withCtx, createVNode, mergeProps, createElementVNode, renderSlot, createTextVNode, toDisplayString, createCommentVNode, createSlots, mergeModels } from "vue";
...
import _sfc_main$3 from "./formRowUi/DigiModalFormRowContainer.vue.js";
...
const _hoisted_1 = { class: "flex flex-col items-start gap-1 empty:hidden" };
const _hoisted_2 = { class: "w-full" };
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "DigiModalFormField",
            ...
            default: withCtx(({ formItemId }) => [
              createVNode(_sfc_main$2, null, {
                default: withCtx(({ state }) => [
                  createVNode(_sfc_main$3, mergeProps({ disabled: __props.disabled }, _ctx.$attrs), {
                    label: withCtx(() => [
                      renderSlot(_ctx.$slots, "top"),
                      createVNode(_sfc_main$6, null, createSlots({
                        default: withCtx(() => [
